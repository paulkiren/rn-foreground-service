...
const metadataTemplate = `
  <meta-data
    android:name="com.paulkiren.foregroundservice.notification_channel_name"
    android:value="Sticky Title"
  />
  <meta-data
    android:name="com.paulkiren.foregroundservice.notification_channel_description"
    android:value="Sticky Description."
  />
  <meta-data
    android:name="com.paulkiren.foregroundservice.notification_color"
    android:resource="@color/blue"
  />
  <service android:name="com.paulkiren.foregroundservice.ForegroundService"></service>
  <service android:name="com.paulkiren.foregroundservice.ForegroundServiceTask"></service>
`;
